        ...
        if filename.endswith('.set'):
            ...
            for condition in conditions:
                ...
                for i_electrode, electrode in enumerate(electrodes):  
                    ...
                    epochs_data = epochs[condition].get_data(copy = True) # Shape : ( 40_epocs, 28_channels, 309_times)
                    ...
                    for time_window, power_spec in power_spec_windows:
                        ...
                        try:
                            ...
                            if fg.has_model: # Had_model returns a boolean array (True if fit sucessuflly fit)
                                exp = fg.get_paramsA('aperiodic_params')[1]
                        ...
                        # Create and append a row for each time window
